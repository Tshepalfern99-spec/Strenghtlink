...
<head>
    <meta charset="UTF-8">
    <title>Sign Up • Strengthlink</title>
...
<body class="antialiased">
    ...
    <div class="w-full max-w-md animate-fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold gradient-text mb-2">Join Strengthlink</h1>
            <p class="text-secondary-600">Create your account to get started</p>
        </div>
        ...
        <div class="glass-effect rounded-2xl shadow-card p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <i class="fas fa-user absolute left-3 top-3.5 text-secondary-400"></i>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" 
                               name="password" 
                               required
                               class="form-input w-full rounded-xl border-gray-200 focus:border-primary-400 py-3 px-4 pl-11 pr-11 bg-white transition-all duration-200"
                               placeholder="Create a strong password">
                        <i class="fas fa-lock absolute left-3 top-3.5 text-secondary-400"></i>
                        <button type="button" class="absolute right-3 top-3.5 text-secondary-400 hover:text-primary-500 transition-colors" onclick="togglePasswordVisibility('password')">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <i class="fas fa-lock absolute left-3 top-3.5 text-secondary-400"></i>
                        <button type="button" class="absolute right-3 top-3.5 text-secondary-400 hover:text-primary-500 transition-colors" onclick="togglePasswordVisibility('password_confirmation')">
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-3 bg-white/80 text-gray-500">Already have an account?</span>
                </div>
            </div>
            ...
            <div class="text-center">
                <a href="{{ route('login') }}" 
                   class="inline-flex items-center justify-center w-full py-3 px-4 border-2 border-primary-500 rounded-xl text-sm font-medium text-primary-600 hover:bg-primary-50 transition-all duration-200">
