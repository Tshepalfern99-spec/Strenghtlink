...
<head>
    <meta charset="UTF-8">
    <title>Login • Strengthlink</title>
...
<body class="antialiased">
    ...
    <div class="w-full max-w-md animate-fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-secondary-600">Sign in to your Strengthlink account</p>
        </div>

        <!-- Login Card -->
        <div class="glass-effect rounded-2xl shadow-card p-8">
            @if (session('status'))
                <div class="mb-6 rounded-xl bg-primary-50 p-4 text-primary-700 border border-primary-200 flex items-center">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="#" class="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-200 rounded-xl text-sm font-medium text-secondary-700 hover:bg-gray-50 transition-all duration-200">
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 text-center">
                <p class="text-sm text-secondary-600">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:text-primary-500 transition-colors ml-1">
                        Create one here
                    </a>
                </p>
            </div>
